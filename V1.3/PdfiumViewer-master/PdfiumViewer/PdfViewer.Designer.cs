...
namespace PdfView
{
    partial class PdfViewer
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._bookmarks = new PdfView.NativeTreeView();
            this._renderer = new PdfView.PdfRenderer();
            ...
            this._saveButton.Image = global::PdfView.Properties.Resources.disk_blue;
            ...
            this._printButton.Image = global::PdfView.Properties.Resources.printer;
            ...
            this._zoomInButton.Image = global::PdfView.Properties.Resources.zoom_in;
            ...
            this._zoomOutButton.Image = global::PdfView.Properties.Resources.zoom_out;
            ...
            // tsbAddImg
            // 
            this.tsbAddImg.CheckOnClick = true;
            this.tsbAddImg.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
            resources.ApplyResources(this.tsbAddImg, "tsbAddImg");
            this.tsbAddImg.Name = "tsbAddImg";
            this.tsbAddImg.CheckedChanged += new System.EventHandler(this.tsbAddImg_CheckedChanged);
            // 
            // _container
            // 
            ...
            this._renderer.Rotation = PdfView.PdfRotation.Rotate0;
            this._renderer.ZoomMode = PdfView.PdfViewerZoomMode.FitHeight;
            this._renderer.LinkClick += new PdfView.LinkClickEventHandler(this._renderer_LinkClick);
            // 
            // PdfViewer
            // 
